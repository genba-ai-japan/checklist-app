...
function getDefaultGanttTasks(): GanttTask[] {
  return [
    ...
    { id: "a5", no: "A5", priority: "○", category: "製造管理", taskName: "週1改善案の立案・実施", specificApproach: "毎週1件以上の改善アイデア", deadline: "通年 週1件以上", periods: p(1, 20), color: "#6b7280" },
    { id: "a6", no: "A6", priority: "○", category: "製造管理", taskName: "追加調理・工程ロス削減", specificApproach: "工程別原因分析→工程表再調整", deadline: "11～12月", periods: p(12, 20), color: "#6b7280" },
    { id: "a7", no: "A7", priority: "△", category: "製造管理", taskName: "在庫管理デジタル化", specificApproach: "在庫管理の問題点洗い出し", deadline: "1～3月", periods: p(1, 3), color: "#9ca3af" },
    ...
    { id: "c1", no: "C1", priority: "○", category: "充填・調理課", taskName: "毎月テーマ設定・品質改善", specificApproach: "お申し出MTG時テーマ決め", deadline: "通年 月1テーマ", periods: p(1, 20), color: "#6b7280" },
    { id: "c2", no: "C2", priority: "○", category: "充填・調理課", taskName: "お申し出・再調理0件維持", specificApproach: "朝礼AIの活用、充填内お申し出管理", deadline: "通年", periods: p(1, 20), color: "#6b7280" },
    { id: "c3", no: "C3", priority: "○", category: "充填・調理課", taskName: "調理課再調理ゼロ", specificApproach: "ルール洗い出し→毎月MTG", deadline: "通年", periods: p(1, 20), color: "#6b7280" },
    { id: "c5", no: "C5", priority: "○", category: "充填・調理課", taskName: "品前・安全衛生資料確認", specificApproach: "毎月W1に確認", deadline: "月1回", periods: p(1, 20), color: "#6b7280" },
    { id: "c6", no: "C6", priority: "○", category: "充填・調理課", taskName: "フィルム使用量削減", specificApproach: "切り替え枚数削減", deadline: "通年", periods: p(1, 20), color: "#6b7280" },
    { id: "c7", no: "C7", priority: "○", category: "充填・調理課", taskName: "1on1 月次実施（全員）", specificApproach: "毎月W1に各メンバーと面談", deadline: "通年 実施率100%", periods: p(1, 20), color: "#6b7280" },
    { id: "c8", no: "C8", priority: "○", category: "充填・調理課", taskName: "井上さんのリーダー候補育成", specificApproach: "目標設定→進捗確認→フィードバック", deadline: "半期で2件実施", periods: p(1, 20), color: "#6b7280" },
    { id: "c9", no: "C9", priority: "△", category: "充填・調理課", taskName: "本平さんのリーダー候補育成", specificApproach: "目標設定→進捗確認→フィードバック", deadline: "半期で2件実施", periods: p(1, 20), color: "#9ca3af" },
    { id: "c10", no: "C10", priority: "△", category: "充填・調理課", taskName: "AI設定（製造注意点）", specificApproach: "毎月AIシステムの更新", deadline: "毎月更新", periods: p(1, 20), color: "#9ca3af" },
    { id: "d1", no: "D1", priority: "△", category: "外部・社内活動", taskName: "面接", specificApproach: "面接の流れ自分なりにまとめる", deadline: "通年", periods: p(1, 20), color: "#9ca3af" },
    ...
    { id: "d3", no: "D3", priority: "△", category: "外部・社内活動", taskName: "工場会議参加・議事録", specificApproach: "工場会議に参加。", deadline: "通年", periods: p(1, 20), color: "#9ca3af" },
  ];
}
