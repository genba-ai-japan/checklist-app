...
export default function RecordsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <main className="px-4 py-4 pb-4 space-y-3">
        {loading ? (
      ...
      {/* 新規登録ボタン */}
      <div className="fixed bottom-16 left-0 right-0 p-4 bg-gradient-to-t from-gray-50 to-transparent pointer-events-none">
        <Link href="/new" className="pointer-events-auto block">
